...
<script>
  ...
  function cetak_all_slip_gaji(){
    if(($('#tahun').val()=='') ||($('#bulan').val()=='')){
      ...
      var url_="<?php echo base_url('payroll/salary/cetak_slip_gaji/')?>/tahun/"+$('#tahun').val()+"/bulan/"+$('#bulan').val()+'/id_departemen/'+id_departemen+'/id_tipe_karyawan/'+id_tipe_karyawan+'/id_karyawan/'+id_karyawan+'/?is_printed=yes';
