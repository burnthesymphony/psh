...
function get_parent_menu(){
	...
	$conf= array('table'	=> 'trs_menu_otoritas as a ',
				 'select'	=> 'a.parent,b.nama_menu,b.link',
				 'where'	=> array('a.id_otoritas'=>$level),
				 'join' 	=> array('table'=>array('mst_menu as b'),'on'=>array('a.parent=b.id_menu'),'method'=>array('left')),
				 'group_by'	=>'a.parent'
				);
...
function get_menu($parent=0){
	...
	$level=$CI->session->userdata('id_otoritas');
	$conf= array('table'	=> 'trs_menu_otoritas as a ',
				 'select'	=> 'a.id_menu,b.nama_menu,b.link',
				 'where'	=> array('a.id_otoritas'=>$level,'a.parent'=>$parent,'b.aktif'=>'YA'),
